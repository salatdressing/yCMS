...
<div class="container mx-auto">
    <h1 class="mt-5">Punkte vergeben</h1>
    <p class="">Hier kannst du einem User Punkte geben.<br>
    </p>
    <form id="form-points" class="mt-5 my-auto" method="POST">
		...
		<div align="right">
        <br>
        <button class="btn btn-lg btn-success" type="submit">Punkt geben</button>
        </div>
    </form>
    ...
    $(document).ready(function(){
        $("#form-points").submit(function(e){
            ...
            if ($("#playername").val() == "") {
                ...
                $.ajax ({
                    type: "POST",
                    url: "ajax/points-b.php",
                    data: $("#form-points").serialize(),
