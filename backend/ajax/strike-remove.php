...
<div class="container mx-auto">
    <h1 class="mt-5">Verwarnung entfernen</h1>
    <p class="">
        Hier kannst du einem User seine letzte Verwarnung entfernen.<br>
    </p>
    <form id="form-strike-remove" class="mt-5 my-auto" method="POST">
		...
		<div align="right">
        <br>
        <button class="btn btn-lg btn-success" type="submit">Verwarnung entfernen</button>
        </div>
    </form>
...
<script>
    $(document).ready(function(){
        $("#form-strike-remove").submit(function(e){
            e.preventDefault();
            //console.log("Success");
            if ($("#playername").val() == "") {
                ...
                $.ajax ({
                    type: "POST",
                    url: "ajax/strike-remove-b.php",
                    data: $("#form-strike-remove").serialize(),
                    ...
                    document.getElementById("form-strike-remove").reset();
                    }
                })
            }
        });
